/**
 * Trigger post-social cron locally (VPS single source of truth)
 * Run: npx tsx scripts/trigger-post-social.ts
 */
...
async function main() {
  ...
  const url = `${baseUrl}/api/cron/post-social`;
  console.log(`🚀 Triggering social distribution...`);
  ...
  console.log('✅ post-social completed');
  console.log(JSON.stringify(json, null, 2));
}

main().catch((e) => {
  console.error('❌ trigger-post-social failed:', e);
  process.exit(1);
});
