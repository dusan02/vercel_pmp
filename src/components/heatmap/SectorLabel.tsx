...
import { getCompanyMetricValue, getMetricSentiment } from '@/lib/heatmap/metricValue';
...
export function SectorLabel({
    ...
    const accentColor = useMemo(() => {
        ...
        const sentiment = getMetricSentiment(perf, metric);
        return sentiment === 'good' ? '#16a34a' : sentiment === 'bad' ? '#dc2626' : '#4b5563';
    }, [node, metric]);
