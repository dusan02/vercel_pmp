    ...
    const rows: RowDef[] = [
        {
            ...
            primary: (m?.altmanZ ?? m?.zScore) != null ? (m?.altmanZ ?? m?.zScore)!.toFixed(2) : 'N/A',
            secondary: compareWith ? ((sm?.altmanZ ?? sm?.zScore) != null ? (sm?.altmanZ ?? sm?.zScore)!.toFixed(2) : 'N/A') : undefined,
        ...
        },
        {
            ...
            primary: (m?.debtRepaymentYears ?? m?.debtRepaymentTime) != null ? `${(m?.debtRepaymentYears ?? m?.debtRepaymentTime)!.toFixed(1)}y` : 'N/A',
            secondary: compareWith ? ((sm?.debtRepaymentYears ?? sm?.debtRepaymentTime) != null ? `${(sm?.debtRepaymentYears ?? sm?.debtRepaymentTime)!.toFixed(1)}y` : 'N/A') : undefined,
