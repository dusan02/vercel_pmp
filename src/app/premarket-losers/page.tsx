      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <nav className="mt-8 pt-6 border-t border-slate-200 dark:border-slate-800">
          ...
          <div className="flex flex-wrap gap-3 text-sm">
            ...
            <Link className="px-3 py-1.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-blue-50 dark:hover:bg-blue-900/30 hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/premarket-movers/weekly">This Week&apos;s Movers</Link>
