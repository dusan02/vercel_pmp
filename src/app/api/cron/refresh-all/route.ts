...
export async function GET(request: NextRequest) {
    ...
    // Distributed lock: prevent overlapping runs (weekly heavy job)
    return withCronLock('refresh-all', 2 * 60 * 60, async () => runRefreshAll());
}

async function runRefreshAll(): Promise<NextResponse> {
